        ...
        <form action="<?= RUTA_URL ?>/formularios/formulario_01" method="POST">
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <input type="text" class="form-control" name="usuario" id="usuario" value="<?= $_SESSION['dataUser']->name .' '.$_SESSION['dataUser']->last_name ;?>" readonly>
                </div>
            </div>
    </div>
    <br>
                        ...
                        <table id="tblContactos" class="display" style="width:100%">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="col-3 border align-cente text-center">
                                        <div>
                                            <input type="text" class="form-control" id="" name="obs_p10" placeholder="Observaciones">
                                        </div>
                                    </td>
                                </tr>
